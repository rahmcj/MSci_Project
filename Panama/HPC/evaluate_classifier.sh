...
if which qiime > /dev/null; then
    qiime rescript evaluate-fit-classifier \
        --i-sequences silva-138.1-ssu-nr99-seqs-515f-806r-uniq.qza \
        --i-taxonomy silva-138.1-ssu-nr99-tax-515f-806r-derep-uniq.qza \
        --o-classifier silva-138.1-ssu-nr99-515f-806r-classifier.qza \
        --o-observed-taxonomy asv-taxonomy-predicted-taxonomy.qza \
        --o-evaluation asv-taxonomy-fit-classifier-evaluation.qzv
else
